 ...
 */ (function (
  ...
  function C (t, o, i) {
    ...
    return n.forEach (function (t) {
      ...
      t.enabled &&
        e (i) &&
        ((o.offsets.popper = c (o.offsets.popper)), (o.offsets.reference = c (
          o.offsets.reference
        )), (o = i (o, t)));
    }), o;
  }
  ...
  function R () {
    this.state.eventsEnabled &&
      (cancelAnimationFrame (this.scheduleUpdate), (this.state = M (
        this.reference,
        this.state
      )));
  }
  ...
  function V (e, t, o, i) {
    ...
    if ('vh' === p || 'vw' === p) {
      ...
      return (a = 'vh' === p
        ...
        : J (document.documentElement.clientWidth, window.innerWidth || 0)), a /
        100 *
        r;
    }
    return r;
    ...
    fe = (function () {
      function t (o, i) {
        ...
        ne (this, t), (this.scheduleUpdate = function () {
          ...
          isCreated: !1,
          scrollParents: [],
        }), (this.reference = o && o.jquery ? o[0] : o), (this.popper = i &&
          i.jquery
          ? i[0]
      ...
      arrow: {
        ...
        fn: function (e, o) {
          ...
          return (v = J (
            _ (s[l] - u, v),
            0
          )), (e.arrowElement = n), (e.offsets.arrow = ((i = {}), pe (
            i,
            m,
            Math.round (v)
          ), pe (i, h, ''), i)), e;
            ...
            var a = e.offsets.popper,
              ...
              y =
                ...
                ((w && 'start' === r && h) ||
                  ...
                  (!w && 'end' === r && u));
            (m || b || y) &&
              ((e.flipped = !0), (m || b) && (i = p[d + 1]), y &&
                (r = K (r)), (e.placement =
                i + (r ? '-' + r : '')), (e.offsets.popper = se (
                {},
                e.offsets.popper,
      ...
      computeStyle: {
        ...
        fn: function (e, t) {
          ...
          var s,
            ...
            b = W ('transform');
          if (
            ((d = 'bottom' == c ? -f.height + h.bottom : h.top), (s = 'right' ==
              u
              ? -f.width + h.right
              : h.left), a && b)
          )
